  ...
  return (
    <>
      ...
      <Canvas colorManagement camera={{ position: [-5, 2, 10], fov: 30 }}>
        ...
        <directionalLight position={0,10,0} intensity={1.5} shadow-mapSize-shawdowMap-width={1024}/>
        <pointLight position={[-10, 0, 20]} intensity={0.5} shadow-mapSize-shawdowMap-height={1024}/>
